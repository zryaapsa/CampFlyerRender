...
import HistoryCampaignLoad from "../components/historyCampaignLoad";
                ...
                <div className="relative z-10 p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {loading ? (
                                Array.from({ length: 3 }).map((_, index) => <HistoryCampaignLoad key={index} />)
                            ) : orders.length > 0 ? (
                                            ...
                                            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300 h-full flex flex-col">
                                                ...
                                                <div className="p-6 flex-1 flex flex-col">
                                                    ...
                                                    <div className="flex items-center text-gray-400 mb-4">
                                                        <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-4 w-full max-w-xs text-center relative transform transition-all duration-300 scale-100">
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-2 mb-4">
                            <p className="text-blue-400 text-xs">
                                <svg className="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button onClick={() => { window.print(); }} className="flex-1 px-2 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-xs text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-200 font-medium">
                                Cetak Tiket
                            </button>
                        </div>
                    </div>
